         ...
         <a class="ui basic blue button" id="addBtn">
          ...
          <div class="ui small modal" id="addModal">
            <i class="close icon"></i>
              ...
              <div class="actions">
                <button class="ui blue button" type="submit" name="add"><i class="checkmark icon"></i> Add Category</button> 
              </div>
              </form>
          </div>
            <!-- END add modal -->
          ...
          <div class="ui small modal" id="editModal">
            ...
            <!-- table -->
          <table class="ui compact celled definition inverted table" id="tableOutput1">
            <thead>
              <tr>
                <th></th>
                <th>Category</th>
                ...
                <tr>
                  <td class="collapsing">
                    <form class="row " action="/confirmCategory" method="POST">
                      <input type="hidden" name="_token" value="{{ csrf_token() }}">
                      <div class="edit1 ui green basic vertical animated button" tabindex="1" id="{{$key}}" value="{{$key}}">
         ...
         <a class="ui basic blue button" id="addBtn1">
          ...
          <div class="ui small modal" id="addModal1">
            <i class="close icon"></i>
              ...
              <div class="actions">
                <button class="ui blue button" type="submit" name="add"><i class="checkmark icon"></i> Add Subcategory</button>
                </form>
              </div>
          </div>
            <!-- END add modal -->
          ...
          <div class="ui small modal" id="editModal1">
            ...
            <!-- table -->
          <table class="ui compact celled definition inverted table" id="tableOutput2">
            <thead>
              <tr>
                <th></th>
                <th>Subcategory</th>
                ...
                <tr>
                  <td class="collapsing">
                    <form action="/confirmSubCategory" method="POST"><input type="hidden" name="_token" value="{{ csrf_token() }}">
                      ...
                      <div class="edit2 ui green basic vertical animated button" tabindex="1" id="{{$key}}" value="{{$key}}">
                        <div class="hidden content">Edit</div>
                        <div class="visible content">
                          <i class="large edit icon"></i>
                        </div>
